    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <head>
                    <meta charset="utf-8">
                    <title> Sản Phẩm - Sơn Specc</title>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="row g-4">
                                            <div class="col-12">
                                                ...
                                                <div class="mb-2"><b>Dòng sản phẩm</b></div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-1"
                                                        value="Spec Hello">
                                                    <label class="form-check-label" for="factory-1">Spec Hello</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-2"
                                                        value="Spec Eko">
                                                    <label class="form-check-label" for="factory-2">Spec Eko</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-3"
                                                        value="Spec Ceo">
                                                    <label class="form-check-label" for="factory-3">Spec Ceo</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-4"
                                                        value="Go Green">
                                                    <label class="form-check-label" for="factory-4">Go Green</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-5"
                                                        value="Spec Walli">
                                                    <label class="form-check-label" for="factory-5">Spec Walli</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-6"
                                                        value="Suporseal">
                                                    <label class="form-check-label" for="factory-6">Suporseal</label>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-1"
                                                        value="Bột Trét">
                                                    <label class="form-check-label" for="target-1">Bột Trét</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-2"
                                                        value="Sơn Chống Thấm">
                                                    <label class="form-check-label" for="target-2">Sơn Chống Thấm<table>
                                                        </table>
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-3"
                                                        value="Sơn Chống Thấm">
                                                    <label class="form-check-label" for="target-3">Sơn Chống Thấm
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-4"
                                                        value="Sơn Ngoại Thất">
                                                    <label class="form-check-label" for="target-4">Sơn Ngoại Thất
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-4"
                                                        value="Sơn Nội Thất">
                                                    <label class="form-check-label" for="target-4">Sơn Nội Thất
                                                    </label>
                                                </div>
